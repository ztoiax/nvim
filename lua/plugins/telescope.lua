			...
			-- 不同telescope命令切换
			{
				...
				config = function()
						...
						collections = {
							file = {
								...
								tabs = {
									{
										name = "recently",
										tele_func = require("telescope").extensions.frecency.frecency,
									},
							...
							git = {
								...
								tabs = {
									...
									{
										name = "diff",
										tele_func = require("telescope").extensions.git_diffs.diff_commits,
									},
							...
							other = {
								...
								tabs = {
									{
										name = "vim命令菜单",
										tele_func = require("telescope").extensions.command_palette.command_palette,
									},
					...
					vim.api.nvim_set_keymap(
						"n",
						"<leader>ff",
						':lua require("search").open({ collection = "file" })<CR>',
						{ noremap = true, silent = true }
					)
					vim.api.nvim_set_keymap(
						"n",
						"<leader>fa",
						':lua require("search").open({ collection = "grep" })<CR>',
						{ noremap = true, silent = true }
					)
					vim.api.nvim_set_keymap(
						"n",
					...
					vim.api.nvim_set_keymap(
						"n",
						"<leader>fo",
						':lua require("search").open({ collection = "other" })<CR>',
						{ noremap = true, silent = true }
					)
				end,
			},
